...
def get_answer(user_question, pine=True):
    if pine:
        vectorstore = chatbot.get_vectorstore(
            PINECONE_KEY, PINECONE_ENV, index_name=index_name
    ...
    additional_text = "(You MUST provide an answer that is no more than 100 words and use bullet points if you have to make a list)"
