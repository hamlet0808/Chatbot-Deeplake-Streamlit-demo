...
class Chatbot:
    def __init__(self, model_name):
        ...
        self.template_v5 = """
                              ...
                              Use provided context to answer the questions.
                              ...
                              VERY IMPORTANT: If the question is not related to startup law and is NOT a greeting, just say "Hmm, I don't think this question is about startup law. I can only provide insights on startup law.  Sorry about that!".
                           """
    ...
    def conversational_chat(self):
        ...
        chain = ConversationChain(
            llm=self.llm, prompt=qa_prompt, memory=self.memory, verbose=True
        )
